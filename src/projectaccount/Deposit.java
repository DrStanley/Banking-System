...
public class Deposit extends javax.swing.JFrame {
    ...
    public void ConnectionMth(){
      //  bal.setEnabled(false);
        ...
        JOptionPane.showMessageDialog(Deposit.this, e.getMessage());
        }
    }
    public Deposit() { 
        initComponents();
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Deposit", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(0, 0, 204))); // NOI18N
        ...
        try{
            ...
            String accN=res.getString("accnum");
                if (accN.equals(res.getString("accnum"))){
                    JOptionPane.showMessageDialog(Deposit.this, "Sign_in successfull !!!");
                    amt.setEnabled(true);
                    Dep.setEnabled(true);
                    ...
                    JOptionPane.showMessageDialog(Deposit.this, "Incorrect data !!!");
                }
    ...
    private void DepActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_DepActionPerformed
        try{    
           ...
           int depID= res.getInt("id");
            ...
            String detal = "Deposit Reciept\n"+"Name: "+name+"\nAccount Number: "+acc+"\nAmount: "+amot;
           JOptionPane.showMessageDialog(Deposit.this, detal);
           detal = "**Deposited***\n"+"Name: "+name+"\nAccount Number: "+acc+"\nAmount: "+amot+"\n Date: "+date;
